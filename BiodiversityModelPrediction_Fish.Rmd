...
sppgroups <- pred %>% 
  select(common_name, origin, tmp, tolerance, tempclust, flowclust) %>% 
  unique() %>% 
  arrange(origin, tmp, tolerance, tempclust, flowclust)
...
sppgroups$tolerance[sppgroups$tolerance == "generalist"] <- "Gen"
...
aa <- ggplot(data = OR)+
  ...
  ggtitle("Native to Introduced Proportional Abundance")+
  labs(fill = "Ratio")
...
bb <- ggplot(data = SP)+
  ...
  scale_fill_gradient2(low = "grey60",
    ...
    theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        legend.text = element_text(size = 12),
        legend.title = element_text(size = 15))+
  ggtitle("Specialist to Generalist Proportional Abundance")+
  labs(fill = "Ratio")
...
a <- ggplot(data = TC)+
  ...
  facet_wrap(~tempclust)+
    theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        legend.text = element_text(size = 12),
        legend.title = element_text(size = 15))+
  ggtitle("Proportional Abundance: Temperature Clusters")+
  labs(fill = "PA")
...
b <- ggplot(data = FC)+
  ...
  facet_wrap(~flowclust, nrow = 2)+
    theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        legend.text = element_text(size = 12),
        legend.title = element_text(size = 15))+
  ggtitle("Proportional Abundance: Streamflow Clusters")+
  labs(fill = "PA")
...
c <- ggplot(data = TA)+
  ...
  facet_wrap(~tmp)+
    theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        legend.text = element_text(size = 12),
        legend.title = element_text(size = 15))+
  ggtitle("Proportional Abundance: Temperature Guilds")+
  labs(fill = "PA")
...
d <- ggplot(data = FA)+
  ...
  facet_wrap(~tolerance)+
    theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        legend.text = element_text(size = 12),
        legend.title = element_text(size = 15))+
  ggtitle("Proportional Abundance: Tolerance Guilds")+
  labs(fill = "PA")
...
e <- ggplot(data = BT)+
  ...
  ggtitle("Proportional Abundance: Brook Trout")+
  labs(fill = "PA")
...
TC <- TC %>% 
  ...
  rename(Tempclust_1 = "1", Tempclust_2 = "2", Tempclust_3 = "3", 
         Tempclust_4 = "4", Tempclust_5 = "5", Tempclust_6 = "6")
...
FC <- FC %>% 
  ...
  rename(Flowclust_1 = "1", Flowclust_2 = "2", Flowclust_3 = "3", 
         Flowclust_4 = "4", Flowclust_5 = "5", Flowclust_6 = "6",
         Flowclust_7 = "7", Flowclust_8 = "8")
...
compare <- left_join(TC, FC, by = c("name", "tnmid")) %>% 
  ...
  left_join(OR, by = c("name", "tnmid")) %>% 
  left_join(SP, by = c("name", "tnmid")) %>% 
  select(-name, -tnmid)
...
test <- test %>% 
  ...
  filter(rownames(test) %in% c("Tempclust_1", "Tempclust_2", "Tempclust_3", "Tempclust_4", 
                               ...
                               "Flowclust_7", "Flowclust_8", "NatIntRatio", "speGenRatio")) %>%
  rename("FS" = "fluvial.specialist", "FD" = "fluvial.dependent", "Gen" = "generalist", "BT" = "Brook.Trout") %>% 
  arrange(desc(cold)) %>% 
  as.matrix()

library(corrplot)
png(file = "tmpfigures/paper1/correlationmatrix.png", res = 200, width = 8, height = 12, units = "in", pointsize = 24)
...
df8 <- df7 %>% 
  filter(trait %in% c("TC_1", "TC_2", "TC_3", "TC_4", "TC_5", "TC_6", 
                      "FC_1", "FC_2", "FC_3", "FC_4", "FC_5", "FC_6", "FC_7", "FC_8", "native", "introduced" ))
df9 <- df7 %>% 
  filter(trait %in% c("cold", "cool", "warm", "fluvial specialist", "fluvial dependent", "generalist", "brook trout"))
...
ggplot(data = df8, mapping = aes(x = trait, y = propabun))+
  ...
  labs(x = "Cluster", y = "Average Proportional Abundance")+
    theme(panel.border = element_rect(colour = "black", fill = NA),
          panel.grid.major = element_blank(),
          panel.grid.minor = element_blank(),
          panel.background = element_blank(),
...
ggplot(data = df9, mapping = aes(x = trait, y = propabun))+
  ...
  facet_grid(rows = vars(elevation), cols = vars(latitude))+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
  labs(x = "Metric", y = "Average Proportional Abundance")+
    theme(panel.border = element_rect(colour = "black", fill = NA),
          panel.grid.major = element_blank(),
          panel.grid.minor = element_blank(),
          panel.background = element_blank(),
...
#   filter(climclust == 5) %>%
#   group_by(COMID, huc12_name, huc12_tnmid) %>% 
#   summarise(clim_5 = sum(propabun, na.rm = T)) %>% 
#   group_by(huc12_name, huc12_tnmid) %>% 
#   summarise(clim_5 = mean(clim_5))
# clim_5 <- left_join(huc12, clim_5, by = c("name" = "huc12_name", "tnmid" = "huc12_tnmid"))
# clim_5$clim_5 <- ifelse(clim_5$clim_5 > 1, 1, clim_5$clim_5)
# 
# clim_5prob <- ggplot(data = clim_5)+
#   geom_sf(aes(fill = clim_5), color = NA)+
#   scale_fill_gradient2(low = "grey60",
#                         mid = "yellow",
#                         high = "green3",
#                         midpoint = .5,
...
#   filter(climclust == 6) %>%
#   group_by(COMID, huc12_name, huc12_tnmid) %>% 
#   summarise(clim_6 = sum(propabun, na.rm = T)) %>% 
#   group_by(huc12_name, huc12_tnmid) %>% 
#   summarise(clim_6 = mean(clim_6))
# clim_6 <- left_join(huc12, clim_6, by = c("name" = "huc12_name", "tnmid" = "huc12_tnmid"))
# clim_6$clim_6 <- ifelse(clim_6$clim_6 > 1, 1, clim_6$clim_6)
# 
# clim_6prob <- ggplot(data = clim_6)+
#   geom_sf(aes(fill = clim_6), color = NA)+
#   scale_fill_gradient2(low = "grey60",
#                         mid = "yellow",
#                         high = "green3",
#                         midpoint = .5,
...
#          propabun > .01) %>%
#   group_by(huc12_name, huc12_tnmid) %>% 
#   summarise(pmk_propabun = mean(propabun, na.rm = T))
# pumpkin_1 <- left_join(huc12, pumpkin_1, by = c("name" = "huc12_name", "tnmid" = "huc12_tnmid"))
# pmkprop <- ggplot(data = pumpkin_1)+
#   geom_sf(aes(fill = pmk_propabun), color = NA)+
#   scale_fill_gradient2(low = "grey60",
#                         mid = "yellow",
#                         high = "green3",
#                         midpoint = .06,
