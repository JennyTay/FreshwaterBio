...
compare <- data.frame(
  coldnat_propabund = coldnat_1$coldnatpropabund,
  coolnat_propabund = coolnat_1$coolnatpropabund,
  warmnat_propabund = warmnat_1$warmnatpropabund,
  warmnonnat_propabund = warmnonnat_1$warmnonnatpropabund,
  coldnat_rich = coldnat$coldnatrich,
  coolnat_rich = coolnat$coolnatrich,
  warmnat_rich = warmnat$warmnatrich,
  warmnonnat_rich = warmnonnat$warmnonnatrich,
  geog_1_propabund = geog_1$geog_1,
  geog_2_propabund = geog_2$geog_2,
  geog_3_propabund = geog_3$geog_3,
  clim_1_propabund = clim_1$clim_1,
  clim_2_propabund = clim_2$clim_2,
  clim_3_propabund = clim_3$clim_3,
  geog_1_rich = geog_rich1$geog_rich1,
  geog_2_rich = geog_rich2$geog_rich2,
  geog_3_rich = geog_rich_3$geog_rich3,
  clim_1_rich = clim_rich_1$clim_rich1,
  clim_2_rich = clim_rich_2$clim_rich2,
  clim_3_rich = clim_rich_3$clim_rich3
