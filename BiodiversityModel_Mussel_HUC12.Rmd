...
#fish host covariates for the fish that we did not model due to being estuarine - for these, we will simply use the raw fish occurrence data and make a variable for whether the fish has been observed in a given HUC12 (0/1 binary variable)
#white perch for the tidewater mucket
#diadromous fish for the alewife floater
#threespined stickleback for the eastern pond mussel
