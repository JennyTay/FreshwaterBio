...
left of here!! need to redo these but using total count / the number of surveys per huc12
```{r}
...
# we need to divide the counts by the total number of surveys per huc12 in each time period.
