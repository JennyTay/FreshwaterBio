...
then we want to attribute each spp code with a HUC 8,,10, 12, flow line id
...
#add the huc8 name to the fish event dataframe
...
#load NHD data
MAflowline <- st_read("C:/Users/jenrogers/Documents/necascFreshwaterBio/SpatialData/NDH/MA/Shape/NHDFlowline.shp")
