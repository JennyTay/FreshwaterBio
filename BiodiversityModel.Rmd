...
composit_OR_figs <- left_join(results2, clusters, by = "common_name") %>% 
...
ggsave(
    filename = paste("tmpfigures/paper1/ORcomposit_prop_abun_byclimate.png", sep = ""),
    plot = last_plot(),
    width = 14,
    height = 9,
    units = "cm",
...
composit_OR_figs <- left_join(results2, temperature, by = "common_name") %>% 
  filter(! OR > 20,
         ! ORCIhigh > 20,
         !is.na(tmp),
         !variable %in% c("latitude", "longitude", "elevation", "watershed area", "BFIWs", "PctOw_Ws", "logRdCrsCat")) %>%
...
ggsave(
    filename = paste("tmpfigures/paper1/ORcomposit_prop_abun_bytemp.png", sep = ""),
    plot = last_plot(),
    width = 14,
    height = 9,
    units = "cm",
...
composit_OR_figs <- left_join(results2, final_traits, by = "common_name") %>% 
  filter(! OR > 20,
         ! ORCIhigh > 20,
         !is.na(tolerance),
         !variable %in% c("latitude", "longitude", "elevation", "watershed area", "BFIWs", "PctOw_Ws", "logRdCrsCat")) %>%
...
ggsave(
    filename = paste("tmpfigures/paper1/ORcomposit_prop_abun_bytolerance.png", sep = ""),
    plot = last_plot(),
    width = 14,
    height = 9,
    units = "cm",
