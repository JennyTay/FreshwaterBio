...
clusters <- read.csv("tmpfigures/fishclusters_bygeography.csv")
clusters <- clusters %>% 
  select(-1) %>% 
  rename(cluster = final.cluster)
...
ggsave(
    filename = paste("tmpfigures/ORcomposit_bygeography.png", sep = ""),
    plot = last_plot(),
    width = 14,
    height = 9,
    units = "cm",
...
ggsave(
    filename = paste("tmpfigures/ORcomposit_bytemp.png", sep = ""),
    plot = last_plot(),
    width = 14,
    height = 9,
    units = "cm",
