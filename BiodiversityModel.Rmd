...
a <- ggplot(data = composit_OR_fig_tmpclust, aes(x = variable, y = OR, color = as.factor(cluster_TP)))+
  ...
  theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        axis.title.y = element_blank(),
        title = element_text(size = 15))+
  labs(color = "Temp clust", y = "odds ratio")
b <- ggplot(data = composit_OR_fig_flowclust, aes(x = variable, y = OR, color = as.factor(cluster_SF)))+
  geom_point(size = 1.5, position=position_dodge(width=0.5))+
  geom_errorbar(aes(ymin = ORCIlow, ymax = ORCIhigh), position=position_dodge(width=0.5))+
  coord_flip()+
  geom_hline(yintercept = 1, color  = "red", linetype = "dashed", size = 1)+
  theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        axis.title.y = element_blank(),
        title = element_text(size = 15))+
  labs(color = "Flow clust", y = NULL)
c <- ggplot(data = composit_OR_fig_tempGrops, aes(x = variable, y = OR, color = as.factor(tmp)))+
  geom_point(size = 1.5, position=position_dodge(width=0.5))+
  geom_errorbar(aes(ymin = ORCIlow, ymax = ORCIhigh), position=position_dodge(width=0.5))+
  coord_flip()+
  geom_hline(yintercept = 1, color  = "red", linetype = "dashed", size = 1)+
  theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        axis.title.y = element_blank(),
        title = element_text(size = 15))+
  labs(color = "Temp Guild", y = NULL)
d <- ggplot(data = composit_OR_fig_tol, aes(x = variable, y = OR, color = as.factor(tolerance)))+
  geom_point(size = 1.5, position=position_dodge(width=0.5))+
  geom_errorbar(aes(ymin = ORCIlow, ymax = ORCIhigh), position=position_dodge(width=0.5))+
  coord_flip()+
  geom_hline(yintercept = 1, color  = "red", linetype = "dashed", size = 1)+
  theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        axis.title.y = element_blank(),
        title = element_text(size = 15))+
  labs(color = "Hab Guild", y = NULL)

e <- ggplot(data = composit_OR_fig_BT, aes(x = variable, y = OR, color = common_name))+
  geom_point(size = 1.5, position=position_dodge(width=0.5))+
  geom_errorbar(aes(ymin = ORCIlow, ymax = ORCIhigh), position=position_dodge(width=0.5))+
  coord_flip()+
  geom_hline(yintercept = 1, color  = "red", linetype = "dashed", size = 1)+
  theme(panel.border = element_rect(colour = "black", fill = NA),
        ...
        axis.title.y = element_blank(),
        title = element_text(size = 15))+
  labs(color = "Species", y = NULL)

g <- arrangeGrob(a, b, 
                 c, d, 
                 e,
             ncol=2, nrow =3)
ggsave(g, file = "tmpfigures/paper1/CompositORPlots.png", 
    width = 25,
    height = 25,
    units = "cm",
    dpi = 300)
