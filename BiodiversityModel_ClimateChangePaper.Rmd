...
This is the biodiversity model, but slightly adjusted to included riparian imperviousness, riparian forest, and watershed forest % in the model, as opposed to watershed imperviousness.   This model will be used for the climate change and management paper (we are still using the original model in the paper 1)
...
summary(mdl)
saveRDS(mdl, paste("C:/Users/jenrogers/Documents/necascFreshwaterBio/model_objects/_Mgmt_Paper_propabun_", unique(dat$common_name), ".rds", sep = ""))
...
saveRDS(mdl, paste("C:/Users/jenrogers/Documents/necascFreshwaterBio/model_objects/_Mgmt_Paper_propabun_", unique(fish_count_with_zeros_filtered$common_name)[i], ".rds", sep = ""))
...
write.csv(val_zero_prob, file = "tmpfigures/val_zero_prob_Mgmt_Paper.csv")
write.csv(prop_abun_validation, file = "tmpfigures/prop_abun_validation_Mgmt_Paper.csv")

#all the species models (53 total) had model convergence

write.csv(results, file = "tmpfigures/raw_results_Mgmt_Paper.csv")

read.csv("tmpfigures/raw_results_Mgmt_Paper.csv")
...
results2$variable[results2$variable == "W95_HIST"] <- "winter floods"
...
results2$variable[results2$variable == "pctWetland_Cat"] <- "Wetland (cat)"
results2$variable[results2$variable == "PctImp_WsRp100"] <- "Impervious (Rip)"
results2$variable[results2$variable == "pctNatural_ripbuf100"] <- "Natural (Rip)"
results2$variable[results2$variable == "PctOw_Ws"] <- "Open Water (Ws)"
results2$variable[results2$variable == "pctForest_ws"] <- "Forest (Ws)"
results2$variable[results2$variable == "pctAg_Ws"] <- "Agriculture (Ws)"
results2$variable[results2$variable == "BFIWs"] <- "BFI (Ws)"
results2$variable[results2$variable == "huc12_damden_sqkm"] <- "dam density"


write.csv(results2, file = "tmpfigures/propabun_results_Mgmt_Paper.csv")
prop_abun_results <- read.csv("tmpfigures/propabun_results_Mgmt_Paper.csv")
...
results_zer$variable[results_zer$variable == "W95_HIST"] <- "winter floods"
...
results_zer$variable[results_zer$variable == "pctWetland_Cat"] <- "Wetland (cat)"
results_zer$variable[results_zer$variable == "PctImp_WsRp100"] <- "Impervious (Rip)"
results_zer$variable[results_zer$variable == "pctNatural_ripbuf100"] <- "Natural (Rip)"
results_zer$variable[results_zer$variable == "PctOw_Ws"] <- "Open Water (Ws)"
results_zer$variable[results_zer$variable == "pctForest_ws"] <- "Forest (Ws)"
results_zer$variable[results_zer$variable == "pctAg_Ws"] <- "Agriculture (Ws)"
results_zer$variable[results_zer$variable == "BFIWs"] <- "BFI (Ws)"
results_zer$variable[results_zer$variable == "huc12_damden_sqkm"] <- "dam density"



write.csv(results_zer, file = "tmpfigures/zeroinfla_results_Mgmt_Paper.csv")
...
prop_abun_validation <- read.csv("tmpfigures/prop_abun_validation_Mgmt_Paper.csv")
...
ggplot(data = df, aes(x = value))+
  ...
  ggtitle("A")
ggsave(
    filename = "tmpfigures/paper2/validationhistogram_zero_Mgmt_Paper.png",
    plot = last_plot(),
    width = 14,
    height = 5,
    units = "cm",
...
ggplot(data = prop_abun_validation, aes(x = r2_rank_propabun))+
  ...
  ggtitle("B")
ggsave(
    filename = "tmpfigures/paper2/validationhistogram_propabun_Mgmt_Paper.png",
    plot = last_plot(),
    width = 14,
    height = 5,
    units = "cm",
...
ggplot(data = df, aes(x = reorder(common_name, -perc_pres), y = perc_pres))+
  ...
  ggtitle("C")
ggsave(
    filename = "tmpfigures/paper2/testingdataratio_Mgmt_Paper.png",
    plot = last_plot(),
    width = 25,
    height = 10,
    units = "cm",
...
#rename variables to make more interpretable
results2$variable[results2$variable == "annual_mean_summer_temp"] <- "Mean summer temp"
results2$variable[results2$variable == "BFI_HIST"] <- "Baseflow index (rch)"
results2$variable[results2$variable == "LO7Q1DT_HIST"] <- "Low flow date"
results2$variable[results2$variable == "W95_HIST"] <- "Winter floods"
results2$variable[results2$variable == "lat"] <- "Latitude"
results2$variable[results2$variable == "long"] <- "Longitude"
...
results2$variable <- factor(results2$variable, levels = c("Mean summer temp", "Baseflow index", "Low flow date", 
                                                          "Winter floods", 
                                                          "Wetland (cat)", "Impervious (Rip)", "Natural (Rip)", "Open Water (Ws)", "Forest (Ws)", "Agriculture (Ws)", 
                                                          "BFI (Ws)", "Dam density", 
...
composit_OR_figs$variable[composit_OR_figs$variable == "PctOw_Ws"] <- "Open Water (Ws)"
...
composit_OR_figs$variable[composit_OR_figs$variable == "BFIWs"] <- "BFI (Ws)"
composit_OR_figs$variable[composit_OR_figs$variable == "huc12_damden_sqkm"] <- "Dam density"

#order the variables so they occurr in the correct/ same order for all figures
composit_OR_figs$variable <- factor(composit_OR_figs$variable, levels = c("Mean summer temp", "Baseflow index", "Low flow date", 
                                                          "Winter floods", 
                                                          "Wetland (cat)", "Impervious (Rip)", "Natural (Rip)", "Open Water (Ws)", "Forest (Ws)", "Agriculture (Ws)", 
                                                          "BFI (Ws)", "Dam density",
                                                          "Latitude", "Longitude", "Elevation", "Watershed area"))
...
ggsave(e, file = "tmpfigures/paper2/CompositORPlotsBT.png", 
    width = 15,
    height = 10,
    units = "cm",
    dpi = 300)
...
ggsave(g, file = "tmpfigures/paper2/CompositORPlots3.png", 
    width = 25,
    height = 15,
    units = "cm",
    dpi = 300)
...
ggsave(g, file = "tmpfigures/paper2/CompositORPlots4.png", 
    width = 25,
    height = 15,
    units = "cm",
    dpi = 300)
